...
<head>
  ...
  <title>View / InternshipApplication</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="listinternshipapplications">ListInternshipApplications</a></li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">View InternshipApplication</h5>
