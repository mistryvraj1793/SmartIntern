...
<head>
  ...
  <title>Report | Company Details</title>
                                    ...
                                    <table class="table datatable datatable-table table-hover" id="myTable">
 										<thead>
 											<tr>
 												...
 												<th>URl</th>
 												<th>Ex Guide</th>
 												<th>Ex Guide Contact Num</th>
												<th>CreatedAt</th>	
												<th>Total internships</th>
												<th>Total Hr, Mentors</th>									
 											</tr>
 										</thead>
 										<tbody>	
										<c:forEach items="${companyDetails }" var="cmpDet" >
											<tr>
												<td>${cmpDet[0] }</td>
												<td>${cmpDet[1] }</td>
												<td>${cmpDet[2] }</td>
