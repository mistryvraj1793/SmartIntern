...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>View CompanyUser</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admindashboard">Home</a></li>
          <li class="breadcrumb-item"><a href="adminlistcompanyusers">ListCompanyUsers</a></li>
          <li class="breadcrumb-item active">ViewCompanyUser</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
 					...
 					<div class="row">
 						<div class="col-12">
 							<div class="card">
 								<div class="card-body">
 									<h5 class="card-title">
 										<span>ViewCompanyUser</span>
 									</h5>
 									
 									Title: ${companyUser.title }<br>
