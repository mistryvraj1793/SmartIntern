...
<head>
  ...
  <title>List / InternshipProjects</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>List InternshipProjects</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admindashboard">Home</a></li>
          <li class="breadcrumb-item">InternshipProjects</li>
          <li class="breadcrumb-item active">ListInternshipProjects</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">List InternshipProjects</h5>
