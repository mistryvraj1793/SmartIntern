    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="listinternshiptechnologies">ListInternshipTechnologys</a></li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">View InternshipTechnology</h5>

			    InternshipTechnologyId: ${allInternshipTechnology.internshipTechnologyId } <br><br>
				TechnologyId: ${allInternshipTechnology.technologyId } <br><br>
