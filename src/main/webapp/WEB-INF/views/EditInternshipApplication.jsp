 					...
 					<div class="row">
 						<div class="col-12">
 							<div class="card">
 								<div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">${adminEditinternApplied[0][12]}</h5>
                                    ...
                                    <div class="row mb-2">
                                    	<div class="col-sm-6">
                                            <label class="form-label"><strong>AppliedBy:</strong></label>
                                            <p>${adminEditinternApplied[0][8]}</p>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-label"><strong>Applicant Role:</strong></label>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <p>${adminEditinternApplied[0][11]}</p>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <p>${adminEditinternApplied[0][16]}</p>
                                        </div>
									    ...
									    <div class="col-sm-6">
											<label for="resume" class="form-label">Resume</label>
											    <c:if test="${not empty adminEditinternApplied[0][5]}">
											    	<a href="${adminEditinternApplied[0][5]}" class="btn btn-outline-secondary btn-sm" target="_blank" download>View Resume</a>
												</c:if>
										</div>
            							...
            							<div class="col-sm-6">
                                            <label class="form-label"><strong>AppliedAt:</strong></label>
                                            <p>${adminEditinternApplied[0][1]}</p>
                                        </div>
									...
									<form class="row g-3 needs-validation" action="adminupdateinternshipapplication" method="post" enctype="multipart/form-data" novalidate>									
										<div class="col-sm-6">
										    <label class="form-label"><strong>Application Status</strong></label>
										    <select class="form-select" name="status" required>
										        <option disabled <c:if test="${empty adminEditinternApplied[0][6]}">selected</c:if>>--Select Status--</option>
										        <option value="PENDING" <c:if test="${adminEditinternApplied[0][6] eq 'PENDING'}">selected</c:if>>Pending</option>
										        <option value="ACCEPTED" <c:if test="${adminEditinternApplied[0][6] eq 'ACCEPTED'}">selected</c:if>>Accepted</option>
										        <option value="REJECTED" <c:if test="${adminEditinternApplied[0][6] eq 'REJECTED'}">selected</c:if>>Rejected</option>
										        <option value="WITHDRAWN" <c:if test="${adminEditinternApplied[0][6] eq 'WITHDRAWN'}">selected</c:if>>WithDrawn</option>
										    </select>
										</div>
