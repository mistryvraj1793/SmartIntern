            ...
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                ...
                <form action="resetpassword" method="post">
                  ...
                  <div class="form-group">
                    <label>OTP *</label>
                    <input type="text" class="form-control p_input" name="otp">
                  </div>
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary btn-block enter-btn" value="reset password">Reset Password</button>
                  </div>
                 <!--  <div class="d-flex">
