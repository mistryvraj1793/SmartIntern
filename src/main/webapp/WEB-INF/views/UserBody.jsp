            ...
            <div class="container pt-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        ...
                        <h1 class="mb-4">About SmartIntern Agency And It's Innovative IT Solutions</h1>
	                        ...
	                        <div class="project-item">
	                            <div class="project-img">
	                                ...
	                                <div class="project-content">
	                                    <a href="userinternshipapplications?internshipId=${intern.internshipId }" class="text-center">
